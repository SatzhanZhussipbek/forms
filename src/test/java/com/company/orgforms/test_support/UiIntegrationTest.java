package com.company.orgforms.test_support;

import com.company.orgforms.OrgformsApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.orgforms.screen")
@ContextConfiguration(classes = {OrgformsApplication.class, UiTestAssistConfiguration.class})
